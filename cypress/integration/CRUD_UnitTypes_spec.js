describe("unitTypes CRUD Page Test", () => {
    beforeEach(() => {
        cy.visit("/UnitTypes/index");
    ...
    it("check if Unit Types are shown", () => {
        cy.get("tbody").first().get('tr').eq(0).get('td').eq(1).should("have.text", "Units");
    });
});
